...
public class Add_task_pageobject {
	...
	@FindBy(xpath = "//*[@id='cont_contact']/div/div[2]/div[2]/div[3]/div[3]/div[1]/div/div/span/app-contactlisticon/div/div/div/button[3]")
	...
	@FindBy(xpath = "//*[@id='userdate2']/igx-input-group/div[1]/igx-prefix/igx-icon")
	...
	@FindBy(xpath = "//*[@id='userdropdown1']")
	public static WebElement dropnumber;
	
	@FindBy(xpath = "//*[@id='usertextbox0']")
	...
	@FindBy(xpath = "(//*[text()='Remainder'])[2]/following::span[1]/i")
