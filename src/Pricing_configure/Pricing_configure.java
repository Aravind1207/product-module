...
public class Pricing_configure extends login_the_page{
	...
	public static void Add_Pricing_Configuration() throws InterruptedException, IOException {
		...
		if (VATrate.isEmpty()) {
			Pricing_configure_pageobject.VATrate.sendKeys("106");
		} else {
		}
		...
		if (surcharge.isEmpty()) {
			Pricing_configure_pageobject.surcharge.sendKeys("106");
		} else {
		}
		...
		if (defaultdeliverycost.isEmpty()) {
			Pricing_configure_pageobject.defaultdeliverycost.sendKeys("106");
		} else {
		}
