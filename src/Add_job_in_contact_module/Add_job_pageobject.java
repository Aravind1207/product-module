...
public class Add_job_pageobject {
	...
	@FindBy(xpath = "//*[@id='cont_contact']/div/div[2]/div[2]/div[3]/div[3]/div[1]/div/div/span/app-contactlisticon/div/div/div/button[2]")
...
//	public static WebElement canceladded;
	...
	@FindBy(xpath = "//*[@class='addbtn']/button")
	...
	@FindBy(xpath = "//*[@class='igx-calendar__body-row']/following::div[1]/following::igx-day-item[24]/span")
	...
	@FindBy(xpath = "(//*[@class='btn-group'])[1]/button")
